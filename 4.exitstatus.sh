...
# In shell scripting we dont bother much on command outputs, But we look for exit status of the commands
# which is executed to determine whether that is successful or failure.
